...
aligns with the role.Highlight the strengths and weaknesses of the applicant in relation to the 
...
if submit1:
    if uploaded_file is not None:
        ...
        response=get_gemini_response(input_prompt1,pdf_content,input=input_text)

        st.subheader("The Response is:")
        st.write(response)
    else:
        st.write("Please upload a PDF format file")
